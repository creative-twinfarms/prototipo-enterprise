...
import { Building2, Users, BarChart3, ChevronDown } from "lucide-react";
...
function MenuSelect({ children, additionalClassNames = "", onClick }: React.PropsWithChildren<MenuSelectProps>) {
  return (
    <div 
      className={clsx("relative rounded-[8px] shrink-0 w-full cursor-pointer transition-all duration-200 hover:bg-[#f0f4f0] hover:scale-[1.02]", additionalClassNames)}
      onClick={onClick}
    >
...
export function Sidebar() {
  ...
  return (
    <div className="hidden md:block fixed left-0 top-[70px] bg-white w-[280px] h-[calc(100vh-70px)] z-10 overflow-y-auto">
          ...
          <div className="w-full">
            ...
            >
              <div className="pl-[16px] pt-[4px] flex flex-col gap-[2px]">
                ...
                <div 
                  className={clsx(
                    "relative rounded-[8px] shrink-0 w-full cursor-pointer transition-all duration-200 hover:scale-[1.01]",
                    isProductoresActive ? "bg-[#e8f5e9]" : "bg-white hover:bg-[#f0f4f0]"
                  )}
                ...
                <div 
                  className={clsx(
                    "relative rounded-[8px] shrink-0 w-full cursor-pointer transition-all duration-200 hover:scale-[1.01]",
                    isDashboardActive ? "bg-[#e8f5e9]" : "bg-white hover:bg-[#f0f4f0]"
                  )}
